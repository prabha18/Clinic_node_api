  ...
  try {
    if (req.jwtToken) {
      ...
      if (decoded) {
        ...
        const count_check = await client.query('select a.employee_id,a.username,a.password,a.userrole_id,a.active_status,a.user_id,b.employee_name  from tbl_user_master as a inner join tbl_employee_master as b on a.employee_id = b.employee_id  where a.username = $1 and a.password = $2', [username, newpwsd_en])
        if(client){
          client.end();
         }
