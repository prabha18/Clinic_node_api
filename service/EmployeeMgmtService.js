    ...
    try {
        if (req.jwtToken) {
            ...
            if (decoded) {
                ...
                inner join tbl_def_gender as b on a.gender_id = b.gender_id inner join tbl_def_city as f on f.city_id = a.city_id left outer join tbl_def_employee_category as e on e.employee_category_id = a.employee_category_id left outer join tbl_def_designation as g on g.designation_id = a.designation_id left outer join tbl_def_department as h on h.department_id = a.department_id
                inner join tbl_def_status as i on a.active_status = i.status_id group by a.employee_id,b.gender_name,e.employee_category_name,g.designation,h.department_name,i.status_name,f.city_name
