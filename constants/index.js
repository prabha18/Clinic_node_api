...
module.exports = { 
  ...
  userMessage: {
    ...
    USER_NAME_CHECK:'Username already exist',
    PATIENT_NAME_CHECK:'Patient record already in used',
    RESET_PASWD: 'Password reset successfully',
    LOGIN_SUCCESS: 'Login Success',
    DUPLICATE_EMPLOYEE: 'Employee already exist',
    DUPLICATION_USER:'User already exist',
    DUPLICATE_REGNUMBER: 'Register Number already exist',
    UNIQUE_REGNUMBER:'Register Number is Unique',
    SKIPPEDPATIENT:'Patient has been paused',
    SKIPPEDRESUME:'Patient has been Resumed',
    DUPLICATE_PATIENT:'Patient is already exist',
